...
return [
    ...
    */
    ...
    'doesnt_contain' => 'Le champ :attribute ne doit pas contenir la valeur spécifiée.',
    ...
    | en utilisant la convention "attribute.rule" pour nommer les lignes. Cela permet
    | de spécifier rapidement une ligne de langue personnalisée pour une règle donnée d'un attribut.
    |
    */
    ...
    'custom' => [
        'password' => [
            ...
            'mixed' => 'Le mot de passe doit contenir au moins une lettre majuscule et une minuscule.',
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour échanger notre attribut d'espace réservé
    | avec quelque chose de plus convivial pour le lecteur, comme "Adresse e-mail" au lieu de
    | "email". Cela nous aide à rendre notre message plus expressif.
    |
    */
